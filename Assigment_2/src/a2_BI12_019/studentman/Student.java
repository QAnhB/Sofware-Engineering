 ...
 *  
 * @object
 *   A typical Student is <pre>s = <i,n,p,a></pre> where <pre> id(i), name(n), phoneNumber(p), address(a) </pre>
 * 
 * @abstract_properties
...
public class Student implements Comparable, Document {
	...
	public String toHtmlDoc() {
		...
		html.append("<html> \n")
		  .append("<head><title>Student:"+id+"-"+name+"</title></head> \n")
		  .append("<body> \n")
		  .append(id + " " + name + " " + phoneNumber + " " + address + "\n")
		  .append("</body></html>");
