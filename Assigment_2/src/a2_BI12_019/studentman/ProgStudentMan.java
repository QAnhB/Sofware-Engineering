...
import a2_BI12_019.kengine.Doc;
import a2_BI12_019.kengine.DocCnt;
import a2_BI12_019.kengine.Engine;
import a2_BI12_019.kengine.Query;
...
public class ProgStudentMan {
	@DomainConstraint(mutable=true,optional=false)
	  ...
	  public Student createStudent(Object[] data) {
		  try {
			  Student student = new Student((int) data[0], data[1].toString(),data[2].toString(),data[3].toString());
			  return student;
		  } catch (NotPossibleException e) {
			  throw new NotPossibleException("Can not created object");
		  }
	  }
	  ...
	  public UndergradStudent createUndergradStudent(Object[] data) throws NotPossibleException {
		  ...
		  try {
			  undergrad = new UndergradStudent((int) data[0], data[1].toString(),data[2].toString(),data[3].toString());
			  return undergrad;
		  } catch (Exception e) {
			  throw new NotPossibleException("Can not created object");
		  }
	  ...
	  public PostgradStudent createPostgradStudent(Object[] data) throws NotPossibleException {
		  PostgradStudent postgrad;
		  try {
			  postgrad = new PostgradStudent((int) data[0], (String) data[1],(String) data[2],(String) data[3], (float) data[4]);
			  return postgrad;
		  } catch (Exception e) {
			  throw new NotPossibleException("Can not created object");
		  }
